...
export const metadata = {
  title: "Privacy Policy — Richa",
  description: "How Richa collects, uses, and protects your personal data.",
};
      ...
      <main>
        ...
        <section className="section" style={{ paddingTop: "1rem" }}>
          <div className="container max-w-3xl prose-dark">
            <p>This Privacy Policy explains how Richa (&ldquo;we&rdquo;, &ldquo;us&rdquo;) collects, uses, and protects information about you when you visit our website or engage our services.</p>
            ...
            <h2>Contact</h2>
            <p>For any privacy-related questions or requests, email <strong>privacy@richa.agency</strong>.</p>
