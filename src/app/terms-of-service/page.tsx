...
export const metadata = {
  title: "Terms of Service — Richa",
  description: "The terms that govern your use of the Richa website and services.",
};
      ...
      <main>
        ...
        <section className="section" style={{ paddingTop: "1rem" }}>
          <div className="container max-w-3xl prose-dark">
            <p>These Terms of Service govern your access to and use of the Richa website and any services we provide. By using our site, you agree to these terms.</p>
            ...
            <p>All content on this website — including text, design, graphics, and logos — is owned by or licensed to Richa and is protected by applicable intellectual property laws. You may not reproduce it without our permission.</p>
            ...
            <p>To the fullest extent permitted by law, Richa is not liable for any indirect, incidental, or consequential losses arising from your use of the website. Nothing in these terms excludes liability that cannot be excluded by law.</p>
            ...
            <h2>Contact</h2>
            <p>Questions about these terms? Email <strong>hello@richa.agency</strong>.</p>
