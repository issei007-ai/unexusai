...
export const metadata = {
  title: "Cookie Policy — Richa",
  description: "How and why Richa uses cookies and similar technologies.",
};
      ...
      <main>
        ...
        <section className="section" style={{ paddingTop: "1rem" }}>
          <div className="container max-w-3xl prose-dark">
            ...
            <p>For how we handle personal data more broadly, see our <a href="/privacy-policy">Privacy Policy</a>. Questions? Email <strong>privacy@richa.agency</strong>.</p>
